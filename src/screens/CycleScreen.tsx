...
const styles = StyleSheet.create({
  ...
  avgValue: { fontFamily: fonts.bodyMedium, fontSize: 56, lineHeight: 56, letterSpacing: -1.6, color: colors.text },
  avgSub: { fontFamily: fonts.body, fontSize: 12.5, lineHeight: 17, color: colors.textMuted50, paddingBottom: 6 },
  ...
  statValue: { fontFamily: fonts.bodyMedium, fontSize: 22, color: colors.text },
  ...
  compareLabel: { flex: 1, fontFamily: fonts.bodyMedium, fontSize: 13.5, color: colors.text },
  comparePct: { fontFamily: fonts.mono, fontSize: 11, color: colors.textMuted50 },
